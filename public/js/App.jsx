    ...
    const producsArr = this.state.products.map((elem, index) => {
      ...
      return (
        <Item key={index}
              ...
              handleCheckboxChange={this.handleCheckboxChange.bind(this, index)}
        />
      )
    });
